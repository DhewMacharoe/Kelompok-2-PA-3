                ...
                <tr class="galeri-row" data-status="<?php echo e($galeri->is_active ? 'aktif' : 'nonaktif'); ?>">
                    ...
                    <td data-label="Aksi">
                        <div style="display: flex; gap: 5px; flex-wrap: nowrap; justify-content: center; align-items: center;">
                            ...
                            <a href="<?php echo e(route('admin.galeri.edit', $galeri)); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\galeri\index.blade.php ENDPATH**/ ?>