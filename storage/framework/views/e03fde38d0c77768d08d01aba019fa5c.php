<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        checkEcho(() => {
            window.Echo.channel('Antrean-channel.<?php echo e(session("current_barbershop_id")); ?>').listen('AntreanUpdate', async (e) => {
            ...
            window.Echo.channel('AntreanList-channel.<?php echo e(session("current_barbershop_id")); ?>').listen('AntreanListUpdate', async (e) => {
                if (!window.isActionInProgress) {
    ...
    function panggil() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch("<?php echo e(route('admin.antrean.panggil')); ?>", {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\antrean\script-index.blade.php ENDPATH**/ ?>