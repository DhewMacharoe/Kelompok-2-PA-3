    ...
    <div class="serving-display">
        ...
        <?php else: ?>
            <button type="button" class="btn-panggil shadow-sm d-inline-flex align-items-center gap-1" disabled aria-disabled="true"
                ...
                title="<?php echo e(\App\Models\Antrean::isOperationalHour() ? 'Tidak ada antrean menunggu' : 'Di luar jam operasional'); ?>">
                <i class="bi bi-megaphone-fill"></i> Panggil
            </button>
        <?php endif; ?>
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\antrean\antrean.blade.php ENDPATH**/ ?>