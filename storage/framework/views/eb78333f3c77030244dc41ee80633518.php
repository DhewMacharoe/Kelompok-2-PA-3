                        ...
                        <tr class="layanan-row" data-name="<?php echo e(strtolower($item->nama)); ?>"
                            ...
                            <td data-label="Aksi">
                                <div style="display: flex; gap: 5px; flex-wrap: nowrap; justify-content: center; align-items: center;">
                                    ...
                                    <a href="<?php echo e(route('admin.layanan.edit', $item->id)); ?>"
                                    ...
                                    <button type="button" class="btn-action btn-hapus shadow-sm btn-delete-alert d-inline-flex align-items-center gap-1"
                                        data-id="<?php echo e($item->id); ?>" data-nama="<?php echo e($item->nama); ?>" style="margin: 0;">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\layanan\index.blade.php ENDPATH**/ ?>