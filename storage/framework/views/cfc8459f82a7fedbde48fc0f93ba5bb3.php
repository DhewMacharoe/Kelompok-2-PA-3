                    ...
                    <div class="status-pelayanan-box p-3 rounded border w-100 bg-white d-flex flex-column justify-content-center">
                        ...
                        <div class="text-center mt-2">
                            <?php if(auth()->check() && isset($antreanSayaAktif) && $antreanSayaAktif): ?>
                                <?php if($antreanSayaAktif->status === 'sedang dilayani'): ?>
...
<?php echo $__env->make('pelanggan.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH K:\Deploy-Argahomes\resources\views/pelanggan/homepage/homepage.blade.php ENDPATH**/ ?>