    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0 rounded-3">
            ...
            <div class="card-body p-4">
                <form action="<?php echo e(route('super-admin.barbershops.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="nama" name="nama" value="<?php echo e(old('nama')); ?>" required placeholder="Contoh: Arga Barbershop atau Salon Cantik">
...
unset($__errorArgs, $__bag); ?>" id="slug" name="slug" value="<?php echo e(old('slug')); ?>" placeholder="Contoh: arga-balige (akan otomatis dibuat jika kosong)">
...
unset($__errorArgs, $__bag); ?>" id="kategori" name="kategori" required onchange="updateColorOptions()">
                                <option value="barbershop" <?php echo e(old('kategori') == 'barbershop' ? 'selected' : ''); ?>>Barbershop (Maskulin)</option>
                                <option value="salon" <?php echo e(old('kategori') == 'salon' ? 'selected' : ''); ?>>Salon (Feminim)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" id="telepon" name="telepon" value="<?php echo e(old('telepon')); ?>" placeholder="Contoh: 0821xxxxxxxx">
...
unset($__errorArgs, $__bag); ?>" id="latitude" name="latitude" value="<?php echo e(old('latitude')); ?>" placeholder="Contoh: 2.386130">
...
unset($__errorArgs, $__bag); ?>" id="longitude" name="longitude" value="<?php echo e(old('longitude')); ?>" placeholder="Contoh: 99.147852">
...
unset($__errorArgs, $__bag); ?>" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap tenant..."><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="deskripsi" name="deskripsi" rows="3" placeholder="Deskripsikan layanan unggulan tenant..."><?php echo e(old('deskripsi')); ?></textarea>
...
<?php echo $__env->make('layouts.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\super_admin\barbershops\create.blade.php ENDPATH**/ ?>