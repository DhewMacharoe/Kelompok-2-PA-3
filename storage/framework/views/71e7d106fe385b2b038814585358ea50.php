            ...
            <div class="col-md-6 col-lg-4">
                <div class="input-group">
                    ...
                    <input type="text" name="search" class="form-control border-start-0 ps-0" 
                           placeholder="Cari nama, username, email..." value="<?php echo e($search ?? ''); ?>">
                </div>
            </div>
            <div class="col-md-3">
                ...
                <?php if($search): ?>
                    <a href="<?php echo e(route('admin.moderasi.index')); ?>" class="btn btn-outline-secondary px-3 ms-2">
                        Reset
                    </a>
                <?php endif; ?>
            </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center fw-semibold text-dark"><?php echo e($total); ?></td>
                            <td class="text-center fw-semibold text-danger"><?php echo e($cancel); ?></td>
                            <td class="text-center fw-semibold text-danger"><?php echo e($noshow); ?></td>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.moderasi.show', $user->id)); ?>" class="btn btn-sm btn-outline-primary px-3">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\moderasi\index.blade.php ENDPATH**/ ?>