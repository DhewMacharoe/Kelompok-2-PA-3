...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-primary next-tab-btn px-4 py-3 fw-semibold shadow-sm" style="background-color: <?php echo e($barbershop->warna_primer ?? '#e8a53a'); ?>; border: none;" data-next="#heroes-tab" aria-label="Lanjut ke Tab Hero">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="button" class="btn btn-primary px-4 py-3 fw-semibold next-tab-btn shadow-sm" style="background-color: <?php echo e($barbershop->warna_primer ?? '#e8a53a'); ?>; border: none;" data-next="#contacts-tab" aria-label="Lanjut ke Tab Kontak">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('admin.barbershop.index')); ?>" class="btn-cancel px-4 py-3 shadow-sm" aria-label="Batal Edit Profil">Batal</a>
                                <button type="submit" class="btn-submit py-3 shadow-sm" aria-label="Simpan Perubahan Profil">Simpan Perubahan</button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH K:\Deploy-Argahomes\resources\views/admin/barbershop/edit.blade.php ENDPATH**/ ?>