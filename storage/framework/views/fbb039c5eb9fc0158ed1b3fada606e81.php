...
<body>
    ...
    <div class="login-card text-center">
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST" class="form-section" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    id="email" aria-label="Alamat Email" placeholder="Email" value="<?php echo e(old('email')); ?>">
...
<?php /**PATH K:\Deploy-Argahomes\resources\views/auth/login.blade.php ENDPATH**/ ?>