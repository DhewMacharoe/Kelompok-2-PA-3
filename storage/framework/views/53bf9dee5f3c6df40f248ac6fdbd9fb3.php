...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="<?php echo e(route('admin.galeri.index')); ?>" class="btn btn-danger py-2 px-4 shadow-sm" aria-label="Batal Tambah Foto">
                        Batal
                    </a>

                    <button type="submit" class="btn btn-primary py-2 px-4 shadow-sm" data-loading-text="Menyimpan..." aria-label="Simpan Foto">
                        Simpan
                    </button>
                </div>
            </form>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH K:\Deploy-Argahomes\resources\views/admin/galeri/create.blade.php ENDPATH**/ ?>