<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.selectService = function(id) {
            if (window.selectedServices.length >= 4) return;
        ...
        function fetchAvailableSlots() {
            ...
            const currentSlug = "<?php echo e(session('current_barbershop_slug')); ?>";
        ...
        checkEcho(() => {
            try {
                window.Echo.channel('AntreanList-channel.<?php echo e($activeBarbershop->id ?? ""); ?>').listen('AntreanListUpdate', (e) => {
            ...
            window.Echo.channel('Antrean-channel.<?php echo e($activeBarbershop->id ?? ""); ?>')
...
<?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\pelanggan\antrean\script-index.blade.php ENDPATH**/ ?>