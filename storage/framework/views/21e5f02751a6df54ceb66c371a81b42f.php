<script type="module">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (logoImg) {
            logoImg.src = "<?php echo e(isset($activeDesign) && $activeDesign->favicon ? asset($activeDesign->favicon) : asset('assets/images/logo.png')); ?>";
...
<?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\pelanggan\homepage\script-index.blade.php ENDPATH**/ ?>