...
<head>
    ...
    <style>
        :root {
            --auth-accent: <?php echo e($activeBarbershop->warna_primer); ?> !important;
            --auth-accent-strong: <?php echo e($activeBarbershop->warna_primer); ?> !important;
        }
        .auth-button--google:hover {
            border-color: <?php echo e($activeBarbershop->warna_primer); ?> !important;
            box-shadow: 0 0 16px <?php echo e($activeBarbershop->warna_primer); ?>33 !important;
        }
    </style>
    <?php endif; ?>
</head>
        ...
        <div class="auth-card auth-card--compact">
            <div class="auth-form">
                <div class="auth-form-inner">
                    ...
                    <form id="firebaseLoginForm" action="<?php echo e(route('firebase.login')); ?>" method="POST" class="d-none">
                        <?php echo csrf_field(); ?>
                    ...
                    <script type="module">
                        const firebaseConfig = {
                            apiKey: "<?php echo e(config('firebase.api_key')); ?>",
                            authDomain: "<?php echo e(config('firebase.auth_domain')); ?>",
                            projectId: "<?php echo e(config('firebase.project_id')); ?>",
                            storageBucket: "<?php echo e(config('firebase.storage_bucket')); ?>",
                            messagingSenderId: "<?php echo e(config('firebase.messaging_sender_id')); ?>",
                            appId: "<?php echo e(config('firebase.app_id')); ?>",
                            measurementId: "<?php echo e(config('firebase.measurement_id')); ?>"
                        };
...
<?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\auth\LoginUser.blade.php ENDPATH**/ ?>