...
<div class="main-container pb-5">
    ...
    <div class="profile-card mx-auto mt-4" style="max-width: 900px;">
        ...
        <div class="profile-header d-flex align-items-center justify-content-between flex-wrap gap-4">
            ...
            <div>
                <a href="<?php echo e(route('admin.barbershop.edit', $barbershop->id)); ?>" class="btn-edit-profile" aria-label="Edit Desain Web">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <?php if(isset($barbershop->kontak['instagram']) && !empty($barbershop->kontak['instagram'])): ?>
                                            <div class="info-value mt-0.5"><a href="<?php echo e($barbershop->kontak['instagram']); ?>" target="_blank" class="text-decoration-none fw-semibold" style="color: <?php echo e($barbershop->warna_primer ?? '#e8a53a'); ?>;" aria-label="Buka profil Instagram">Buka Instagram <i class="fas fa-external-link-alt ms-1 small" aria-hidden="true"></i></a></div>
                                        <?php else: ?>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <?php if(isset($barbershop->kontak['facebook']) && !empty($barbershop->kontak['facebook'])): ?>
                                            <div class="info-value mt-0.5"><a href="<?php echo e($barbershop->kontak['facebook']); ?>" target="_blank" class="text-decoration-none fw-semibold" style="color: <?php echo e($barbershop->warna_primer ?? '#e8a53a'); ?>;" aria-label="Buka profil Facebook">Buka Facebook <i class="fas fa-external-link-alt ms-1 small" aria-hidden="true"></i></a></div>
                                        <?php else: ?>
                                            <div class="info-value mt-0.5">-</div>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH K:\Deploy-Argahomes\resources\views/admin/barbershop/index.blade.php ENDPATH**/ ?>