<?php $__env->startSection('title', 'Tambah Design Web'); ?>
...
<style>
    ...
    .form-header {
        background: linear-gradient(135deg, #1e1e24 0%, <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?> 100%);
        padding: 25px 30px;
        color: #fff;
    }
    .form-label { 
    ...
    .form-control:focus { 
        border-color: <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?>; 
        box-shadow: 0 0 0 0.25rem <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?>25; 
    }
    .input-group-text {
    ...
    .custom-pills .nav-link.active {
        ...
        color: white;
        box-shadow: 0 4px 12px <?php echo e(($activeDesign->warna_primer ?? '#e8a53a')); ?>30;
        border-color: <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?>;
    }
    .hero-config-card {
        border-radius: 12px;
    ...
    .btn-submit:hover { 
        ...
        box-shadow: 0 6px 16px <?php echo e(($activeDesign->warna_primer ?? '#e8a53a')); ?>40;
    }
    .btn-cancel { 
        background-color: #f8f9fa; 
        color: #495057; 
...
<div class="content-body pb-5">
    <div class="form-card card mx-auto mt-4" style="max-width: 850px;">
        <div class="form-header">
            <h4 class="mb-1 fw-bold text-white"><i class="fas fa-plus-circle me-2"></i>Tambah Desain & Profil Web</h4>
            <p class="mb-0 text-white-50 small">Buat konfigurasi desain web baru untuk website Anda.</p>
        </div>

        <div class="card-body p-4">
            <form action="<?php echo e(route('admin.barbershop.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>

                <!-- Tabs Form Navigation -->
                <ul class="nav nav-pills custom-pills row g-2 mb-4" id="createTabs" role="tablist">
...
unset($__errorArgs, $__bag); ?>" id="nama_brand" name="nama_brand" value="<?php echo e(old('nama_brand')); ?>" required placeholder="Contoh: Arga Home's">
...
unset($__errorArgs, $__bag); ?>" id="slogan" name="slogan" value="<?php echo e(old('slogan', 'Barber, Coffee & Food')); ?>" required placeholder="Contoh: Barber, Coffee & Food">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12 mb-3">
                                <label for="favicon" class="form-label">Favicon / Logo Brand (Opsional)</label>
...
unset($__errorArgs, $__bag); ?>" id="favicon" name="favicon" accept="image/*">
                                <small class="text-muted d-block mt-1">Format: JPG, PNG, GIF, SVG, ICO. Maks 2MB.</small>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="info@argahomes.com">
...
unset($__errorArgs, $__bag); ?>
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="card p-3 bg-light border-0 h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <input type="hidden" name="warna_primer" id="warna_primer" value="<?php echo e(old('warna_primer', '#E8A53A')); ?>">
                                    <span class="text-muted mt-2" style="font-size: 0.75rem;">
                                        Pilihan warna kontras tinggi yang disesuaikan dengan kategori <strong><?php echo e(($activeBarbershop->kategori ?? 'barbershop') === 'barbershop' ? 'Barbershop' : 'Salon'); ?></strong>.
                                    </span>
...
unset($__errorArgs, $__bag); ?>" id="alaamat" name="alaamat" rows="3" required placeholder="Jl.P.Siantar Km 2, Tampubolon, Balige..."><?php echo e(old('alaamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-primary next-tab-btn px-4 py-2 fw-semibold" style="background-color: <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?>; border: none;" data-next="#heroes-tab">
...
unset($__errorArgs, $__bag); ?>" id="deskripsi_hero" name="deskripsi_hero" rows="4" required placeholder="Tulis deskripsi selamat datang untuk halaman utama..."><?php echo e(old('deskripsi_hero', 'Tempat pangkas rambut premium dengan layanan walk-in queue. Dapatkan pengalaman grooming terbaik!')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Gambar Hero Beranda (Opsional)</label>
...
unset($__errorArgs, $__bag); ?>" id="judul_hero_layanan" name="judul_hero_layanan" value="<?php echo e(old('judul_hero_layanan', 'Daftar Layanan')); ?>" required placeholder="Contoh: Daftar Layanan">
...
unset($__errorArgs, $__bag); ?>" id="deskripsi_hero_layanan" name="deskripsi_hero_layanan" rows="2" required placeholder="Lihat pilihan layanan yang tersedia..."><?php echo e(old('deskripsi_hero_layanan', 'Lihat pilihan layanan yang tersedia beserta harga dan estimasi waktunya.')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Gambar Hero Layanan (Opsional)</label>
...
unset($__errorArgs, $__bag); ?>" id="judul_hero_galeri" name="judul_hero_galeri" value="<?php echo e(old('judul_hero_galeri', 'Galeri Kami')); ?>" required placeholder="Contoh: Galeri Kami">
...
unset($__errorArgs, $__bag); ?>" id="deskripsi_hero_galeri" name="deskripsi_hero_galeri" rows="2" required placeholder="Lihat suasana barbershop kami..."><?php echo e(old('deskripsi_hero_galeri', 'Lihat suasana barbershop, hasil potongan rambut, dan area coffee sebelum datang ke tempat.')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Gambar Hero Galeri (Opsional)</label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="button" class="btn btn-primary px-4 py-2 fw-semibold next-tab-btn" style="background-color: <?php echo e($activeDesign->warna_primer ?? '#e8a53a'); ?>; border: none;" data-next="#contacts-tab">
...
unset($__errorArgs, $__bag); ?>" id="whatsapp" name="whatsapp" value="<?php echo e(old('whatsapp')); ?>" placeholder="Contoh: 0821-6789-3019">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="instagram" name="instagram" value="<?php echo e(old('instagram')); ?>" placeholder="https://instagram.com/akun">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="facebook" name="facebook" value="<?php echo e(old('facebook')); ?>" placeholder="https://facebook.com/halaman">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="link_map" name="link_map" value="<?php echo e(old('link_map')); ?>" placeholder="https://maps.app.goo.gl/xyz">
                                </div>
...
unset($__errorArgs, $__bag); ?>" id="map_embed" name="map_embed" rows="3" placeholder="Contoh: https://www.google.com/maps/embed?pb=..."><?php echo e(old('map_embed')); ?></textarea>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const kategori = '<?php echo e($activeBarbershop->kategori ?? "barbershop"); ?>';
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\s6\pa 3\pa_3v3\Kelompok-2-PA-3\resources\views\admin\barbershop\create.blade.php ENDPATH**/ ?>