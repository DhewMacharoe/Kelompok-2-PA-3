...
<div class="detail-container">
    <div class="detail-card">
        ...
        @else
            <div class="detail-img" style="display:flex; align-items:center; justify-content:center; color:#8b97a6; font-weight:600;">Tidak ada gambar</div>
        @endif

        <div class="detail-body">
            <div class="detail-item">
                <strong>Kategori</strong>
                <span>{{ ucfirst($layanan->kategori) }}</span>
            </div>
            <div class="detail-item">
                <strong>Harga</strong>
