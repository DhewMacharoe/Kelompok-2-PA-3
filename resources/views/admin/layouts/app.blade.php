...
<head>
    ...
    <title>@yield('title', 'Dashboard') - {{ $activeDesign->nama_brand ?? 'Antrean App' }}</title>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $activeDesign->nama_brand ?? 'Arga Barbershop Admin' }}">
