                             ...
                             <div class="col-md-6 mb-3">
                                <div class="card p-3 bg-light border-0 h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <span class="text-muted mt-2" style="font-size: 0.75rem;">
                                        Pilihan warna kontras tinggi yang disesuaikan dengan kategori <strong>{{ ($activeBarbershop->kategori ?? 'barbershop') === 'barbershop' ? 'Barbershop' : 'Salon' }}</strong>.
                                    </span>
                                    @error('warna_primer')
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const kategori = '{{ $activeBarbershop->kategori ?? "barbershop" }}';
