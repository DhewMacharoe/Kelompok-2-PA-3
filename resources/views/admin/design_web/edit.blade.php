...
<style>
    ...
    .form-control:focus { 
        border-color: {{ $design->warna_primer ?? '#e8a53a' }}; 
        box-shadow: 0 0 0 0.25rem {{ $design->warna_primer ?? '#e8a53a' }}25; 
    }
    .input-group-text {
    ...
    .custom-pills .nav-link.active {
        ...
        color: white;
        box-shadow: 0 4px 12px {{ ($design->warna_primer ?? '#e8a53a') }}30;
        border-color: {{ $design->warna_primer ?? '#e8a53a' }};
    }
    .hero-config-card {
        border-radius: 12px;
    ...
    .btn-submit:hover { 
        ...
        box-shadow: 0 6px 16px {{ ($design->warna_primer ?? '#e8a53a') }}40;
    }
    .btn-cancel { 
        background-color: #f8f9fa; 
        color: #495057; 
                ...
                <div class="tab-content" id="editTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="profile-pane" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row g-3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="row align-items-center g-3">
                                    <div class="col-auto">
                                        @if($design->favicon)
                                            <img src="{{ asset($design->favicon) }}" alt="Favicon" class="img-thumbnail rounded shadow-sm" style="max-height: 55px; max-width: 55px; object-fit: contain; padding: 2px;">
                                        @else
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $design->email) }}" required placeholder="info@argahomes.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card p-3 bg-light border-0 h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <input type="color" class="form-control form-control-color border-0" id="warna_primer" name="warna_primer" value="{{ old('warna_primer', $design->warna_primer ?? '#e8a53a') }}" title="Pilih warna dasar" style="width: 50px; height: 40px; padding: 2px; border-radius: 6px;">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('alaamat') is-invalid @enderror" id="alaamat" name="alaamat" rows="3" required placeholder="Jl.P.Siantar Km 2, Tampubolon, Balige...">{{ old('alaamat', $design->alaamat) }}</textarea>
                                @error('alaamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="card p-3 bg-light border-0">
                                    <div class="form-check form-switch m-0">
                                        <input class="form-check-input" type="checkbox" role="switch" id="is_cafe_active" name="is_cafe_active" value="1" {{ old('is_cafe_active', $design->is_cafe_active ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-primary next-tab-btn px-4 py-2 fw-semibold" style="background-color: {{ $design->warna_primer ?? '#e8a53a' }}; border: none;" data-next="#heroes-tab">
                    ...
                    <div class="tab-pane fade" id="heroes-pane" role="tabpanel" aria-labelledby="heroes-tab">
                        ...
                        <div class="hero-config-card p-3 mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <textarea class="form-control @error('deskripsi_hero') is-invalid @enderror" id="deskripsi_hero" name="deskripsi_hero" rows="4" required placeholder="Tulis deskripsi selamat datang untuk halaman utama...">{{ old('deskripsi_hero', $design->deskripsi_hero) }}</textarea>
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if($design->gambar_hero)
                                        <div class="mb-2">
                                            <img src="{{ asset($design->gambar_hero) }}" alt="Current Hero" class="img-thumbnail rounded shadow-sm" style="max-height: 80px; object-fit: cover; width: 100%;">
                                        </div>
                                    @endif
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control @error('deskripsi_hero_layanan') is-invalid @enderror" id="deskripsi_hero_layanan" name="deskripsi_hero_layanan" rows="2" required placeholder="Lihat pilihan layanan yang tersedia...">{{ old('deskripsi_hero_layanan', $design->deskripsi_hero_layanan) }}</textarea>
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if($design->gambar_hero_layanan)
                                        <div class="mb-2">
                                            <img src="{{ asset($design->gambar_hero_layanan) }}" alt="Current Services Hero" class="img-thumbnail rounded shadow-sm" style="max-height: 80px; object-fit: cover; width: 100%;">
                                        </div>
                                    @endif
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control @error('deskripsi_hero_galeri') is-invalid @enderror" id="deskripsi_hero_galeri" name="deskripsi_hero_galeri" rows="2" required placeholder="Lihat suasana barbershop kami...">{{ old('deskripsi_hero_galeri', $design->deskripsi_hero_galeri) }}</textarea>
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if($design->gambar_hero_galeri)
                                        <div class="mb-2">
                                            <img src="{{ asset($design->gambar_hero_galeri) }}" alt="Current Gallery Hero" class="img-thumbnail rounded shadow-sm" style="max-height: 80px; object-fit: cover; width: 100%;">
                                        </div>
                                    @endif
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control @error('deskripsi_hero_menu') is-invalid @enderror" id="deskripsi_hero_menu" name="deskripsi_hero_menu" rows="2" required placeholder="Nikmati pilihan minuman kopi...">{{ old('deskripsi_hero_menu', $design->deskripsi_hero_menu) }}</textarea>
                                ...
                                <div class="col-md-5">
                                    ...
                                    @if($design->gambar_hero_menu)
                                        <div class="mb-2">
                                            <img src="{{ asset($design->gambar_hero_menu) }}" alt="Current Menu Hero" class="img-thumbnail rounded shadow-sm" style="max-height: 80px; object-fit: cover; width: 100%;">
                                        </div>
                                    @endif
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="button" class="btn btn-primary px-4 py-2 fw-semibold next-tab-btn" style="background-color: {{ $design->warna_primer ?? '#e8a53a' }}; border: none;" data-next="#contacts-tab">
                    ...
                    <div class="tab-pane fade" id="contacts-pane" role="tabpanel" aria-labelledby="contacts-tab">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{ old('instagram', $design->kontak['instagram'] ?? '') }}" placeholder="https://instagram.com/akun">
                                </div>
                                @error('instagram')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('facebook') is-invalid @enderror" id="facebook" name="facebook" value="{{ old('facebook', $design->kontak['facebook'] ?? '') }}" placeholder="https://facebook.com/halaman">
                                </div>
                                @error('facebook')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('link_map') is-invalid @enderror" id="link_map" name="link_map" value="{{ old('link_map', $design->kontak['link_map'] ?? '') }}" placeholder="https://maps.app.goo.gl/xyz">
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('map_embed') is-invalid @enderror" id="map_embed" name="map_embed" rows="3" placeholder="Contoh: https://www.google.com/maps/embed?pb=...">{{ old('map_embed', $design->kontak['map_embed'] ?? '') }}</textarea>
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.design.index') }}" class="btn-cancel px-4 py-2">Batal</a>
