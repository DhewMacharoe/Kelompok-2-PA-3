...
<style>
    ...
    .form-header {
        background: linear-gradient(135deg, #1e1e24 0%, {{ $activeDesign->warna_primer ?? '#e8a53a' }} 100%);
        padding: 25px 30px;
        color: #fff;
    }
    .form-label { 
    ...
    .form-control:focus { 
        ...
        box-shadow: 0 0 0 0.25rem {{ $activeDesign->warna_primer ?? '#e8a53a' }}25; 
    }
    .input-group-text {
    ...
    .custom-pills .nav-link.active {
        ...
        color: white;
        box-shadow: 0 4px 12px {{ ($activeDesign->warna_primer ?? '#e8a53a') }}30;
        border-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }};
    }
    .hero-config-card {
        border-radius: 12px;
    ...
    .btn-submit:hover { 
        ...
        box-shadow: 0 6px 16px {{ ($activeDesign->warna_primer ?? '#e8a53a') }}40;
    }
    .btn-cancel { 
        background-color: #f8f9fa; 
        color: #495057; 
                    ...
                    <div class="tab-pane fade show active" id="profile-pane" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="info@argahomes.com">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card p-3 bg-light border-0 h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <input type="color" class="form-control form-control-color border-0" id="warna_primer" name="warna_primer" value="{{ old('warna_primer', '#e8a53a') }}" title="Pilih warna dasar" style="width: 50px; height: 40px; padding: 2px; border-radius: 6px;">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('alaamat') is-invalid @enderror" id="alaamat" name="alaamat" rows="3" required placeholder="Jl.P.Siantar Km 2, Tampubolon, Balige...">{{ old('alaamat') }}</textarea>
                                @error('alaamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="card p-3 bg-light border-0">
                                    <div class="form-check form-switch m-0">
                                        <input class="form-check-input" type="checkbox" role="switch" id="is_cafe_active" name="is_cafe_active" value="1" {{ old('is_cafe_active', true) ? 'checked' : '' }}>
                        ...
                        <div class="hero-config-card p-3 mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <textarea class="form-control @error('deskripsi_hero') is-invalid @enderror" id="deskripsi_hero" name="deskripsi_hero" rows="4" required placeholder="Tulis deskripsi selamat datang untuk halaman utama...">{{ old('deskripsi_hero', 'Tempat pangkas rambut premium dengan layanan walk-in queue. Dapatkan pengalaman grooming terbaik!') }}</textarea>
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control @error('deskripsi_hero_layanan') is-invalid @enderror" id="deskripsi_hero_layanan" name="deskripsi_hero_layanan" rows="2" required placeholder="Lihat pilihan layanan yang tersedia...">{{ old('deskripsi_hero_layanan', 'Lihat pilihan layanan yang tersedia beserta harga dan estimasi waktunya.') }}</textarea>
                            ...
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control @error('deskripsi_hero_menu') is-invalid @enderror" id="deskripsi_hero_menu" name="deskripsi_hero_menu" rows="2" required placeholder="Nikmati pilihan minuman kopi...">{{ old('deskripsi_hero_menu', 'Nikmati berbagai pilihan makanan dan minuman kopi yang tersedia di barbershop kami.') }}</textarea>
                                ...
                                <div class="col-md-5">
                                    <label class="form-label">Gambar Hero Menu (Opsional)</label>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('instagram') is-invalid @enderror" id="instagram" name="instagram" value="{{ old('instagram') }}" placeholder="https://instagram.com/akun">
                                </div>
                                @error('instagram')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('facebook') is-invalid @enderror" id="facebook" name="facebook" value="{{ old('facebook') }}" placeholder="https://facebook.com/halaman">
                                </div>
                                @error('facebook')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" class="form-control @error('link_map') is-invalid @enderror" id="link_map" name="link_map" value="{{ old('link_map') }}" placeholder="https://maps.app.goo.gl/xyz">
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('map_embed') is-invalid @enderror" id="map_embed" name="map_embed" rows="3" placeholder="Contoh: https://www.google.com/maps/embed?pb=...">{{ old('map_embed') }}</textarea>
                                </div>
