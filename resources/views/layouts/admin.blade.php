...
<head>
    ...
    <title>@yield('title', $activeDesign->nama_brand ?? 'Admin Barbershop')</title>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $activeDesign->nama_brand ?? 'Arga Barbershop' }}">
    <link class="apple-touch-icon" rel="apple-touch-icon" href="{{ isset($activeDesign) && $activeDesign->favicon ? asset($activeDesign->favicon) : asset('assets/images/logo.png') }}">
</head>
