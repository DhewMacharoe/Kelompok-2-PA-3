    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0 rounded-3">
            ...
            <div class="card-body p-4">
                <form action="{{ route('super-admin.barbershops.update', $barbershop->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-3">
                        <label for="nama" class="form-label fw-bold">Nama Tenant <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $barbershop->nama) }}" required placeholder="Contoh: Arga Barbershop atau Salon Cantik">
                        @error('nama')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $barbershop->slug) }}" placeholder="Contoh: arga-balige (akan otomatis dibuat jika kosong)">
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('kategori') is-invalid @enderror" id="kategori" name="kategori" required onchange="updateColorOptions()">
                                <option value="barbershop" {{ old('kategori', $barbershop->kategori) == 'barbershop' ? 'selected' : '' }}>Barbershop (Maskulin)</option>
                                <option value="salon" {{ old('kategori', $barbershop->kategori) == 'salon' ? 'selected' : '' }}>Salon (Feminim)</option>
                            </select>
                            @error('kategori')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon" name="telepon" value="{{ old('telepon', $barbershop->telepon) }}" placeholder="Contoh: 0821xxxxxxxx">
                            @error('telepon')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check form-switch pt-2">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" {{ old('is_active', $barbershop->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="any" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude', $barbershop->latitude) }}" placeholder="Contoh: 2.386130">
                            @error('latitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="any" class="form-control @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude', $barbershop->longitude) }}" placeholder="Contoh: 99.147852">
                            @error('longitude')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap tenant...">{{ old('alamat', $barbershop->alamat) }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="3" placeholder="Deskripsikan layanan unggulan tenant...">{{ old('deskripsi', $barbershop->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="{{ route('super-admin.barbershops.index') }}" class="btn btn-outline-secondary px-4 py-2" aria-label="Batal Edit Tenant">Batal</a>
                        <button type="submit" class="btn btn-gold px-4 py-2" aria-label="Simpan Perubahan Tenant">Simpan Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
