<style>
    ...
    /* Custom Colors */
    .bg-gold-accent {
        background-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }} !important;
    }
    ...
    .btn-gold-accent {
        background-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }} !important;
        color: #ffffff !important;
        border: 1px solid {{ $activeDesign->warna_primer ?? '#e8a53a' }} !important;
        transition: all 0.25s ease;
    }

    .btn-gold-accent:hover {
        background-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }}e6 !important;
        border-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }}e6 !important;
        color: #ffffff !important;
    ...
    .hero-cta-btn:hover {
        ...
        border-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }}e6;
        transform: translateY(-3px);
        box-shadow: 0 6px 20px {{ $activeDesign->warna_primer ?? '#e8a53a' }}59;
    }
    ...
    .queue-icon-circle.border-gold-accent {
        border: 2px solid {{ $activeDesign->warna_primer ?? '#d4af37' }} !important;
    }
    ...
    .menu-grid-card:hover {
        ...
        border-color: {{ $activeDesign->warna_primer ?? '#e8a53a' }} !important;
        box-shadow: 0 10px 25px {{ $activeDesign->warna_primer ?? '#e8a53a' }}14 !important;
    }
    ...
    .link-hover-effect:hover {
        color: {{ $activeDesign->warna_primer ?? '#e8a53a' }}e6 !important;
    ...
    .footer-custom {
        ...
        border-top: 3px solid {{ $activeDesign->warna_primer ?? '#e8a53a' }} !important;
