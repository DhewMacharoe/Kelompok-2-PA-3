        ...
        @forelse ($menus as $menu)
            <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card haircut-card shadow-sm border-0 h-100">
                    @php
                        // Sementara: kode lama (hardcoded)
                        // <img src="https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?q=80&w=600" class="card-img-top haircut-img" alt="Espresso">
                        $fotoMenu = null;
                        if (!empty($menu->foto)) {
