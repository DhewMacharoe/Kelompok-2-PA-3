...
@section('content')
    ...
    <section class="layanan-content">
        ...
        <div class="layanan-grid">
            ...
            <div class="layanan-card">
                <div class="layanan-card-image">
                    <img src="https://images.unsplash.com/photo-1517832606299-7ae9b720a186?q=80&w=1200&auto=format&fit=crop"
                        alt="Potong Rambut dan Cuci">
                </div>
                <div class="layanan-card-body">
                    <h4>Potong Rambut + Cuci</h4>
                    <p class="layanan-desc">Layanan potong rambut yang dilengkapi cuci rambut agar terasa lebih segar dan
                        bersih.</p>
            ...
            <div class="layanan-card">
                <div class="layanan-card-image">
                    <img src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?q=80&w=1200&auto=format&fit=crop"
                        alt="Cukur Jenggot dan Kumis">
                </div>
                <div class="layanan-card-body">
                    <h4>Cukur Jenggot & Kumis</h4>
                    <p class="layanan-desc">Perapihan jenggot dan kumis untuk tampilan wajah yang lebih bersih dan terawat.
                    </p>
            ...
            <div class="layanan-card">
                <div class="layanan-card-image">
                    <img src="https://images.unsplash.com/photo-1519699047748-de8e457a634e?q=80&w=1200&auto=format&fit=crop"
                        alt="Hair Styling">
                </div>
                <div class="layanan-card-body">
                    <h4>Hair Styling</h4>
                    <p class="layanan-desc">Penataan rambut menggunakan produk styling agar hasil akhir lebih rapi dan
                        menarik.</p>
            ...
            <div class="layanan-card">
                <div class="layanan-card-image">
                    <img src="https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?q=80&w=1200&auto=format&fit=crop"
                        alt="Creambath Rambut">
                </div>
                <div class="layanan-card-body">
                    <h4>Creambath Rambut</h4>
                    <p class="layanan-desc">Perawatan rambut untuk membantu membersihkan kulit kepala dan membuat rambut
                        lebih rileks.</p>
            ...
            <div class="layanan-card">
                <div class="layanan-card-image">
                    <img src="https://images.unsplash.com/photo-1622287162716-f311baa1a2b8?q=80&w=1200&auto=format&fit=crop"
                        alt="Paket Lengkap">
                </div>
                <div class="layanan-card-body">
                    <h4>Paket Lengkap</h4>
                    <p class="layanan-desc">Potong rambut, cuci rambut, dan penataan rambut dalam satu layanan yang lebih
                        lengkap.</p>
